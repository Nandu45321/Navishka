...
class ScaleneTriangleScreenView(Screen):
    def queans(self):
        ...
        if side_1_input != '' and side_2_input != '' and side_3_input != '':
            ...
            self.ids.area_value.hint_text = str("{:.3f}".format((semi_perimeter * (semi_perimeter - float(side_1_input)) * (semi_perimeter - float(side_2_input)) * (semi_perimeter - float(side_3_input))) ** (1 / 2)))
